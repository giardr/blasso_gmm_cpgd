...
| `run_grid_search.py`      | Script used to generate raw results for Section 4.5 of the article (influence of separation and sample size on performance). Results are later processed in `cpgd_experiments.ipynb`.|
